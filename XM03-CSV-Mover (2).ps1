...
# Generate a move request for each element of the array
    $XM3_1 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd06.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM3_2 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd06.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM3_3 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd06.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM3_4 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd06.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM3_5 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd06.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM3_6 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd06.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM3_7 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd06.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM3_8 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd06.janus.cap -confirm:$false
    $movesuccess=$?
