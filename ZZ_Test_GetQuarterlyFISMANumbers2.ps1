...
#$NewUsers | select surname,givenname,mail,whenCreated | export-csv C:\Temp\FismaQuarterlyOutput\OSNewUsers.csv -nti
...
#$NewUsers | select surname,givenname,mail,whenCreated | export-csv C:\Temp\FismaQuarterlyOutput\EISNewUsers.csv -nti
...
#$NewUsers | select surname,givenname,mail,whenCreated | export-csv C:\Temp\FismaQuarterlyOutput\SRVNewUsers.csv -nti
...
#$NewUsers | select surname,givenname,mail,whenCreated | export-csv C:\Temp\FismaQuarterlyOutput\BCNewUsers.csv -nti
...
#$NewUsers | select surname,givenname,mail,whenCreated | export-csv C:\Temp\FismaQuarterlyOutput\DOINewUsers.csv -nti
...
#$NewUsers | select surname,givenname,mail,whenCreated | export-csv C:\Temp\FismaQuarterlyOutput\DOI_BCNewUsers.csv -nti
...
#$NewUsers | select surname,givenname,mail,whenCreated | export-csv C:\Temp\FismaQuarterlyOutput\DOI_OSNewUsers.csv -nti
...
#$NewUsers | select surname,givenname,mail,whenCreated | export-csv C:\Temp\FismaQuarterlyOutput\DOI_OHANewUsers.csv -nti
...
New-Item -path "C:\Temp\FismaQuarterlyOutput" -Name "DeleteMe" -type "directory"
import-module c:\Scripts\CombineCSV.psm1
cd C:\Temp\FismaQuarterlyOutput\
$a = gci | where {$_.name -like "*.csv"}
$b = $a | where {$_.name -notlike "*Service*"}
foreach ($zz in $b.name){
copy-item $zz DeleteMe
}
Combine-CSV -SourceFolder "C:\Temp\FismaQuarterlyOutput\DeleteMe\" -Filter "*.csv" -ExportFileName "NoPIVOCIO_Elevated1.csv"
Import-CSV "C:\Temp\FismaQuarterlyOutput\DeleteMe\NoPIVOCIO_Elevated1.csv" -delimiter ";"| Where {$_.SmartcardLogonRequired -EQ "False"} | Export-CSV "C:\Temp\FismaQuarterlyOutput\NoPIVOCIO_Elevated.csv" -delimiter ";" -NTI
Remove-Item C:\Temp\FismaQuarterlyOutput\DeleteMe -Recurse -Force
