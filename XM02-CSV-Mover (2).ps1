...
# Generate a move request for each element of the array
    $XM2_1 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd05.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM2_2 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd05.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM2_3 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd05.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM2_4 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd05.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM2_5 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd05.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM2_6 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd05.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM2_7 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd05.janus.cap -confirm:$false
    $movesuccess=$?
...
# Generate a move request for each element of the array
    $XM2_8 | New-MoveRequest -targetdatabase "$store" -AcceptLargeDataLoss -baditemlimit Unlimited -DomainController p-jcdcd05.janus.cap -confirm:$false
    $movesuccess=$?
